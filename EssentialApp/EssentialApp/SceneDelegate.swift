...
class SceneDelegate: UIResponder, UIWindowSceneDelegate {
    ...
    func scene(_ scene: UIScene, willConnectTo session: UISceneSession, options connectionOptions: UIScene.ConnectionOptions) {
        ...
        let feedViewControler = FeedUIComposer.feedComposedWith(feedLoader: feedLoaderWithFallback, imageLoader: feedImageLoaderWithFallback)
        
        window?.rootViewController = feedViewControler
    }
